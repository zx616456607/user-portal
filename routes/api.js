...
module.exports = function (Router) {
  ...
  router.get('/devops/cd-rule/type/:type', devopsController.getDeploymentCDRule)
  router.delete('/devops/cd-rule/type/:type', devopsController.deleteDeploymentCDRule)
