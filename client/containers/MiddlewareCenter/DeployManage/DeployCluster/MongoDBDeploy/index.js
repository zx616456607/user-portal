...
import './style/mongoDBDeploy.less'
                    ...
                    <div className="commonBox pwd">
                      ...
                      <div className="inputBox">
                        <FormItem
                          hasFeedback
                        >
                          <Input {...userNameProps} size="large" placeholder="请输入用户名" disabled={isFetching} />
                        </FormItem>
                      </div>
                      <div style={{ clear: 'both' }}></div>
                    </div>
                    <div className="commonBox pwd">
                      ...
                      <div className="inputBox">
                        ...
                        >
                          ...
                          <i className={this.state.showPwd === 'password' ? 'fa fa-eye' : 'fa fa-eye-slash'} onClick={this.checkPwd}/>
                        </FormItem>
                      </div>
                      <div style={{ clear: 'both' }}></div>
                    </div>
