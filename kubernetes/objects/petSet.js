...
class Petset {
      ...
      template: {
        metadata: {
          ...
          annotations: {
            ...
            'pod.alpha.kubernetes.io/init-containers': '[{"name":"install","image":"index.tenxcloud.com/google_containers/galera-install:0.1","imagePullPolicy":"Always","args":["--work-dir=/work-dir"],"volumeMounts":[{"name":"workdir","mountPath":"/work-dir"},{"name":"config","mountPath":"/etc/mysql"}]},{"name":"bootstrap","image":"index.tenxcloud.com/docker_library/debian:jessie","command":["/work-dir/peer-finder"],"args":["-on-start=\"/work-dir/on-start.sh\"","-service=' + name + '"],"env":[{"name":"POD_NAMESPACE","valueFrom":{"fieldRef":{"apiVersion":"v1","fieldPath":"metadata.namespace"}}}],"volumeMounts":[{"name":"workdir","mountPath":"/work-dir"},{"name":"config","mountPath":"/etc/mysql"}]}]'
          }
        },
        spec: {
  ...
  createMysqlDatabase(instanceNum, password) {
    ...
    this.spec.template.spec.containers[0].env.value = password
