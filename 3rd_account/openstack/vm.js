...
const getRequestUrl = common.getRequestUrl(`${openstackConfig.protocol}://${openstackConfig.host}:${openstackConfig.vmPort}`)
const find = require('lodash/find')
const baseUrl = `${openstackConfig.protocol}://${openstackConfig.host}`
