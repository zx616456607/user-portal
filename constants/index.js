...
exports.ROLE_USER = 0
exports.ROLE_TEAM_ADMIN = 4//公有云，基本废弃，要添加角色,4是暂时赋的值
exports.ROLE_SYS_ADMIN = 10
exports.ROLE_PLATFORM_ADMIN = 2
exports.ROLE_BASE_ADMIN = 1
...
exports.IP_PATH_REGEX = /^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])([/][a-zA-Z]+)+$/
