...
exports.CIDR_REGEX = /^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\/[0-9]+$/
...
exports.K8S_NODE_SELECTOR_OS_KEY = 'beta.kubernetes.io/os'
