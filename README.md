...
变量名 | 默认值 | 说明 | 可选值
---|---|---|---
NODE_ENV | `'development'` | Node 运行模式 | `'development'`, `'production'`
...
NOREPLY_EMAIL_PWD | `undefined` | noreply@tenxcloud.com 邮箱密码
...
DEVOPS_EXTERNAL_PROTOCOL | `'https'` | 服务的外网协议 | `'http'`, `'https'`
DEVOPS_EXTERNAL_HOST | `'cicdv2.tenxcloud.com'` | 服务的外网地址
