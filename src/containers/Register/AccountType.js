    ...
    return (
      <div id="AccountType">
        ...
        <div className="account">
          <div className="accountInf" style={{marginRight:'30px'}}>
        ...
        <Button onClick={() => this.handlePageChange(true)}>register(person)</Button>
        <Button onClick={() => this.handlePageChange(false)}>register(company)</Button>
      </div>
    )
  }
}