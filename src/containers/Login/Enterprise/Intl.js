...
export const mapData = {
  ...
  data: {
    ...
    // tipsFailed: '登录名或者密码错误，还可以尝试 {retryTimes} 次',
    tipsDisabbledLogin: '超过重试次数，请 {minutes} 分钟后再试',
    tipsCaptchaRequired: '请输入验证码后重新登录',
    tipsCaptchaError: '验证码错误',
    tipsCaptchaErrorFirst: '登陆频繁出错，请输入验证码',
